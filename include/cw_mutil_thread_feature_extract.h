#ifndef _CW_MUTIL_THREAD_FEATURE_EXTRACT_H_
#define _CW_MUTIL_THREAD_FEATURE_EXTRACT_H_
...
#ifdef MTFE_C_EXPORTS_C_EXPORTS
#define MTFE_C_EXPORTSDLL_C __declspec(dllexport)
#else
#define MTFE_C_EXPORTSDLL_C
#endif
